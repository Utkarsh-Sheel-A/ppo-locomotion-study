"""
Watch a trained Ant PPO agent live in a MuJoCo window, or record it to .mp4.
Picks the run by --lr, matching train_ant_ppo.py's naming (ant_ppo_lr<value>).

    python watch_and_record_ant.py --lr 3e-4                    # live window (default)
    python watch_and_record_ant.py --lr 1e-4 --mode record       # save an .mp4
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr", type=float, default=3e-4, help="which lr run to load, e.g. 3e-4 or 1e-4")
